...
const ListeProduit = () => {
    ...
    const handleShowModal = (produit) => {
        ...
        setFormData({
            ...
            idType: produit.id_type.id_type,
            images: []
        });
        setShowModal(true);
    };
    ...
    const handleUpdate = async (e) => {
        ...
        try {
            ...
            setShowModal(false);
            AllProduit(); // Refresh the list after update
        } catch (error) {
            console.error(error);
    ...
    return (
        <>
            <Toaster />
            <div className='w-100'>
                <h3 className='mt-3 mb-3'>Liste des produits</h3>
                        ...
                        <Form onSubmit={handleUpdate}>
                            ...
                            <Form.Group controlId="formType" className="mt-3">
                                ...
                                >
                                    ...
                                    {Array.isArray(Produit) && Produit.length > 0 ? (
                                        Produit.map((type) => (
                                            <option key={type.id_type.id_type} value={type.id_type.id_type}>
                                                {type.id_type.nom}
                                            </option>
                                        ))
                                    ) : (
