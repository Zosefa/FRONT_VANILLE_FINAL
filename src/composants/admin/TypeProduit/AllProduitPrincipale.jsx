...
const AllProduitPrincipale = () => {
    ...
    const handleUpdate = async () => {
        ...
        const updatedData = {
            id: selectedType.id_type, 
            nom: selectedType.nom,
        };

        try {
            await axios.post(`http://localhost:8080/Type/update_Type`, updatedData, {
                headers: {
                    'Authorization': `Bearer ${token}`
                }
            });
    ...
    return (
        ...
        <Toaster />
            <div className='w-100'>
                <h3 className='mt-3 mb-3'>Liste des Types de produits principales</h3>
...
export default AllProduitPrincipale;
